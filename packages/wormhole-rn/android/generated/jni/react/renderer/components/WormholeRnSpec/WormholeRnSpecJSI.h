...
template <typename T>
class JSI_EXPORT NativeWormholeRnCxxSpec : public TurboModule {
public:
  static constexpr std::string_view kModuleName = "WormholeRn";

protected:
  NativeWormholeRnCxxSpec(std::shared_ptr<CallInvoker> jsInvoker) : TurboModule(std::string{NativeWormholeRnCxxSpec::kModuleName}, jsInvoker) {
...
private:
  static jsi::Value __installRustCrate(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    ...
    return bridging::callFromJs<bool>(rt, &T::installRustCrate,  static_cast<NativeWormholeRnCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));
  }
  ...
  static jsi::Value __cleanupRustCrate(jsi::Runtime &rt, TurboModule &turboModule, const jsi::Value* /*args*/, size_t /*count*/) {
    ...
    return bridging::callFromJs<bool>(rt, &T::cleanupRustCrate,  static_cast<NativeWormholeRnCxxSpec*>(&turboModule)->jsInvoker_, static_cast<T*>(&turboModule));
  }
};
