...
import installer from './NativeWormholeRn';
...
export * from './generated/wormhole_core';

// Now import the bindings so we can:
// - intialize them
// - export them as namespaced objects as the default export.
import * as wormhole_core from './generated/wormhole_core';
...
if (!initialized) {
  wormhole_core.default.initialize();
  initialized = true;
}
